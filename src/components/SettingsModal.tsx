...
const PROVIDER_OPTIONS: ProviderOption[] = [
  ...
  },
  {
    id: "gemini",
    name: "Google Gemini",
    desc: "Google's latest models including Gemini 3.8 Flash and Gemini 2.5 Flash.",
    defaultModel: "gemini-2.5-flash",
    models: [
      { value: "gemini-3.8-flash", label: "Gemini 3.8 Flash (latest generation)" },
  ...
  },
  {
    id: "openai",
    name: "OpenAI",
    desc: "GPT-4.1 series — OpenAI's latest generation. gpt-4.1-mini is fast and cost-efficient.",
    ...
    models: [
      ...
      { value: "o3", label: "o3 (reasoning, most capable)" },
    ],
  },
  {
    id: "groq",
    name: "Groq",
    desc: "Ultra-low latency inference. Llama 4 Maverick is the latest high-capability model.",
    defaultModel: "llama-4-maverick-17b-128e-instruct",
    models: [
      { value: "llama-4-maverick-17b-128e-instruct", label: "Llama 4 Maverick 17B (recommended)" },
      { value: "llama-4-scout-17b-16e-instruct", label: "Llama 4 Scout 17B (fast)" },
      { value: "llama-3.3-70b-versatile", label: "Llama 3.3 70B (fallback)" },
    ],
  },
  {
    id: "anthropic",
    name: "Anthropic Claude",
    desc: "Claude 4 series — Anthropic's latest generation models.",
  ...
  },
  {
    ...
    models: [
      ...
      { value: "llama3.2:1b", label: "Llama 3.2 1B (fast & light)" },
